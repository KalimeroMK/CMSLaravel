...
class StaticController extends Controller {
	...
	public function index() {
		...
		return view('admin.staticpage.staticpage')->with($data);
	}
	...
	public function create() {
		...
		return view('admin.staticpage.createstaticpage')->with($data);
	}
	...
	public function edit($id) {
		...
		return view('admin.staticpage.editstaticpage')->with($data);
	}
